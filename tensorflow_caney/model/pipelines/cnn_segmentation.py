...
# main
#
# python cnn_segmentation.py -c config.yaml -d config.csv -s preprocess train
# -----------------------------------------------------------------------------
def main():
...
if __name__ == "__main__":
    ...
    # /explore/nobackup/people/jacaraba/development/tensorflow-caney/tests/data/segmentation_test.yaml
    # /explore/nobackup/people/jacaraba/development/tensorflow-caney/tests/data/segmentation_test.csv
    sys.exit(main())
